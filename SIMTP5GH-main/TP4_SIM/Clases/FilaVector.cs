...
namespace TP4_SIM
{
    public class FilaVector
    {
        ...
        private LlegadaCorteLuz llegadaCorte;
        ...
        public FilaVector()
        {
            ...
            this.llegadaCorte = new LlegadaCorteLuz();
            ...
            this.fin_corte = new FinCorteLuz();
        ...
        */
        ...
        public LlegadaCorteLuz LlegadaCorteLuz { get => llegadaCorte; set => llegadaCorte = value; }
        public FinCorteLuz FinCorteLuz { get => fin_corte; set => fin_corte = value; }
    }
}
