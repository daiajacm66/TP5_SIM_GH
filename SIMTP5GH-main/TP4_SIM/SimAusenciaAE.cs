...
namespace TP4_SIM
{
    public partial class SimAusenciaAE : Form
    {
        ...
        private void simularAusenciaAE(object sender, EventArgs e)
        {
            ...
            fila1.ComienzoAusencia.ProxAusencia = 0.1;
            ...
            for (int i = 0; i < cantFilas; i++)
            {
                ...
                if ((i + 1) >= nroPrimeraFilaMostrar && (i + 1) <= nroUltimaFilaMostrar)
                {
                    ...
                    listaAux1.Add(fila1.ComienzoAusencia.ProxAusencia.ToString());
                    listaAux1.Add(fila1.Fin_ausencia.Fin.ToString());
                ...
                if (fila2.Evento == "comienzo_ausencia")
                {
                    ...
                    fila2.Fin_ausencia.Fin = fila2.Reloj + 12;
                    fila2.ComienzoAusencia.ProxAusencia = fila2.Reloj + 60;
                ...
                else
                {
                    ...
                    listaAux.Add(fila2.ComienzoAusencia.ProxAusencia.ToString());
                    listaAux.Add(fila2.Fin_ausencia.Fin.ToString());
        ...
        public static void agregarColumnasTabla(DataTable tablaResultado)
        {
            ...
            tablaResultado.Columns.Add("Prox ausencia");
            tablaResultado.Columns.Add("Fin ausencia");
